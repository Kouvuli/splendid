...
import { fetchUserById } from "../../redux/reducers/profileSlice"
...
const Profile = () => {
  ...
  const { currentUser, data, loading, error } = useSelector(profileSelector)
  useEffect(() => {
        ...
        <div className={styles["main-container"]}>
          <div className={styles["profile"]}>
            <div className={styles["profile-avatar"]}>
              <img src={DefaultUser} alt="" className={styles["profile-img"]} />
              ...
              <div className={`${styles["event"]} ${styles["box"]}`}>
                <div className={styles["event-wrapper"]}>
                  ...
                  <div className={styles["event-date"]}>
                    <div className={styles["event-month"]}>Jan</div>
                    <div className={styles["event-day"]}>01</div>
                  </div>
                  <div className={styles["event-title"]}>Winter Wonderland</div>
              ...
              <div className={`${styles["album"]} ${styles["box"]}`}>
                <div className={styles["status-main"]}>
                  ...
                  <div className={styles["album-detail"]}>
                    ...
                    <div className={styles["album-date"]}>6 hours ago</div>
                  </div>
                  <button className={styles["intro-menu"]}></button>
                </div>
                ...
                <div className={styles["album-actions"]}>
                  <a href="#" className={styles["album-action"]}>
                    <svg
                      stroke="currentColor"
                      strokeWidth="2"
                      fill="none"
